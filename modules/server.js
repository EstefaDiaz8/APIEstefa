...
class Server {
    constructor() {
        ...
        this.insumosPath = '/api/insumos'; // Define la ruta base para las operaciones relacionadas con insumos
    ...
    routes() {
        ...
        this.app.use(this.insumosPath, require('../routes/insumos')); // Ruta para las operaciones relacionadas con insumos
